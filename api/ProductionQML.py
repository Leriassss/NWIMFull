...
class ProductionQML(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._parameters = {}
        self._methods = ProductionFactory.getMethodKeys()
    ...
    def parameterNames(self):
        ...
        if self._current_method:
            return ProductionFactory.getModelParameters(self._current_method)
        return {}
    ...
    def setMethod(self, index):
        ...
        if method_name in ProductionFactory.methods:
            self._current_method =  method_name
            self._parameters = {key: None for key in ProductionFactory.getModelParameters(method_name)}
    ...
    def updateParameter(self, key, value):
        ...
        model = ProductionFactory.getModel(self._current_method)
