...
class OptimizationQML(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._parameters = {}
        self._methods = OptimizationFactory.getMethodKeys()
    ...
    def parameterNames(self):
        ...
        if self._current_method:
            return OptimizationFactory.getModelParameters(self._current_method)
        return {}
    ...
    def setMethod(self, index):
        ...
        if method_name in OptimizationFactory.methods:
            self._current_method =  method_name
            model_class = OptimizationFactory.getModel(method_name)

            model_instance = model_class()

            pars = {key: getattr(model_instance, key) for key in OptimizationFactory.getModelParameters(method_name)}
    ...
    def updateParameter(self, key, value):
        ...
        model = OptimizationFactory.getModel(self._current_method)
