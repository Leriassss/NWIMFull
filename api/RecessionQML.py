...
class RecessionQML(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._parameters = {}
        self._methods = RecessionFactory.getMethodKeys()
    ...
    def parameterNames(self):
        ...
        if self._current_method:
            return RecessionFactory.getModelParameters(self._current_method)
        return {}
    ...
    def setMethod(self, index):
        ...
        if method_name in RecessionFactory.methods:
            self._current_method = method_name
            self._parameters = {key: None for key in RecessionFactory.getModelParameters(method_name)}
    ...
    def updateParameter(self, key, value):
        ...
        model = RecessionFactory.getModel(self._current_method)
