...
class RoutingQML(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._parameters = {}
        self._methods = RoutingFactory.getMethodKeys()
    ...
    def parameterNames(self):
        ...
        if self._current_method:
            return RoutingFactory.getModelParameters(self._current_method)
        return {}
    ...
    def setMethod(self, index):
        ...
        if method_name in RoutingFactory.methods:
            self._current_method = method_name
            self._parameters = {key: None for key in RoutingFactory.getModelParameters(method_name)}
    ...
    def updateParameter(self, key, value):
        ...
        model = RoutingFactory.getModel(self._current_method)
