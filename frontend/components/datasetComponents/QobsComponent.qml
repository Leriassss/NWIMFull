...
Column{
    ...
    Connections {
        ...
        onDataDictChanged:{
            ...
            qCalibrationChart.updateChart(fileHandler.datesInfos["data_cal"],fileHandler.qInfos["data_cal"])
            qValidationChart.updateChart(fileHandler.datesInfos["data_val"],fileHandler.qInfos["data_val"])
        }
    }
