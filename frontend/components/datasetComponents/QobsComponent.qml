...
Column{
    ...
    Connections {
        ...
        function onQInfosChanged() {
            ...
            qCalibrationChart.updateChart(
                ...
                fileHandler.qInfos["data_cal"],fileHandler.pInfos["data_cal"]
            );

            qValidationChart.updateChart(
                fileHandler.datesInfos["data_val"],
                fileHandler.qInfos["data_val"],fileHandler.pInfos["data_cal"]
            );
        }
    }
    ...
    Row {
        ...
        Rectangle {
            id: simulationPane
            width: parent.width * 0.58 - parent.spacing -parent.padding
            height: parent.height
