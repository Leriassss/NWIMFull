...
from backend.initialLoss.models.AmountLossModel import AmountLossModel
from backend.ptq.PTQ import PTQ


class AmountLoss(Loss) :
    def __init__(self, ptq : PTQ, data_model: AmountLossModel):
    ...
    def compute(self):
        ...
        return np.maximum(0,rainfall_ini_loss - self.ptq.etp)
